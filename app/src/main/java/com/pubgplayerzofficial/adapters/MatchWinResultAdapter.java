...
public class MatchWinResultAdapter extends RecyclerView.Adapter<MatchWinResultAdapter.MyClass> {

    private Context context;
    private List<Result> resultList;

    public MatchWinResultAdapter(Context context, List resultList) {
    ...
    @NonNull
    @Override
    public MatchWinResultAdapter.MyClass onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_match_win_result, viewGroup, false);
