...
public class ParticipatedMatchAdapter extends RecyclerView.Adapter<ParticipatedMatchAdapter.MyClass> {
    ...
    public ParticipatedMatchAdapter(Context context, List resultList) {
    ...
    @NonNull
    @Override
    public ParticipatedMatchAdapter.MyClass onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_participatedmatch, viewGroup, false);
...
//                }
        ...
        myClass.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PlayMatchViewFragment playMatchViewFragment = PlayMatchViewFragment.newInstance(data, true);
...
//                            Toast.makeText(context, workName.trim(), Toast.LENGTH_SHORT).show();
    ...
    public void moveFragment(Fragment fragment) {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.frgcontainer, fragment, "parti")
                .addToBackStack(null)
                .commit();
    }
